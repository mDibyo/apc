...
class IkSolver(object):
    ...
    env = None
    robot = None
    basePositions = np.load(osp.join(DATA_DIRECTORY,"simulated","reachability1_base.npy"))
    objPoses = np.load(osp.join(DATA_DIRECTORY,"simulated","reachability1_gripper.npy"))
