...
class DynamicSimulationRobotWorld(DynamicSimulation, RobotWorld):
    ...
    def execute_trajectory_qtcoin(self, full_traj, step_viewer=1, interactive=False,
                                  max_cart_vel_trans_traj=.05, sim_callback=None, frame_time=0.01):
        ...
        # raw_input()
        animate_traj.animate_traj_qtcoin(traj, self.robot, restore=False, pause=interactive,
        ...
        traj = ropesim.retime_traj(self.robot, dof_inds, traj)
